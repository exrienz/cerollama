    ...
    try:
        ...
        if request.stream:
            ...
            return ChatResponse(
                ...
                usage=Usage(
                    prompt_tokens=completion_data.get("usage", {}).get("prompt_tokens", 0),
                    completion_tokens=completion_data.get("usage", {}).get("completion_tokens", 0),
                    total_tokens=completion_data.get("usage", {}).get("total_tokens", 0)
                )
            )
    except Exception as e:
